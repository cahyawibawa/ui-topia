    ...
    >
      ...
      >
        <motion.div
          ...
          style={{ backgroundAttachment: "fixed" }}
          className="-top-6 absolute left-0 h-6 w-[40%] rounded-tl-[22px] rounded-tr-[12px]"
        >
          <motion.div
            initial={{
              backgroundImage:
            ...
            className="-right-3 absolute top-3 size-3"
          />
        </motion.div>
      </motion.div>
      <motion.div
      ...
      >
        <div className="relative aspect-[1.5/1] h-[87%] scale-[65%] overflow-hidden bg-black bg-no-repeat [mask:url(data:image/svg+xml;base64,)]">
          <motion.div
            ...
            className="absolute size-[500px] rounded-full bg-[radial-gradient(at_center,rgba(255,255,255,0.95),rgba(255,255,255,0.3)_100%)]"
          />
          <motion.div
            initial={{ height: 0 }}
            animate={isOpen ? { height: "100%" } : {}}
            className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-40% from-black"
          />
        </div>
      </motion.div>
    </div>
...
export default function FolderOpenDemo() {
