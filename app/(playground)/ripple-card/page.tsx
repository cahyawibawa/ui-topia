          ...
          <div className="relative mt-4 px-8 pb-8">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-sm font-light leading-relaxed text-white/75">
                Spot bugs, catch common issues, and fix them automatically,
                before they pop up in production.
              </p>

              <div className="mt-4 flex">
                <div className="rounded-full border border-cyan-400 bg-cyan-400/10 px-3 py-1 text-sm font-light text-cyan-100">
